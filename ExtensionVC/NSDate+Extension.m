 ...
 *  计算toDate和self的时间差距
 */
- (NSInteger)minutesToDate:(NSDate *)toDate {

    NSDateComponents *component = [self componentsToDate:toDate];
    NSInteger i=component.minute + component.hour*60 + component.day*24*60 + component.year*365*24*60;
   return i;
}
